...
public abstract class BaseServiceImpl<E extends Base, Id extends Serializable> implements IBaseService<E, Id> {
    ...
    public BaseServiceImpl(BaseRepository<E, Id> baseRepository) throws Exception {
    ...
    public void delete(Id id) throws Exception {
        try {
            ...
            if (entityOptional.isPresent()) {
                ...
                throw new Exception("No se encontró la entidad con el ID proporcionado.");
            }
        } catch (Exception e) {
            throw new Exception("Error al intentar eliminar la entidad: " + e.getMessage());
        }
    }
